...
describe('Hawk', function() {
  describe('#header', function() {
    it('should return a valid authorization header (sha1)', function() {
      ...
      return expect(header).toEqual('Hawk id="123456", ts="1353809207", nonce="Ygvqdz", hash="bsvY3IfUllw6V5rvk4tStEvpBhE=", ext="Bazinga!", mac="7C9FoI+X70bBQQiL2E6eYm8b4zE="');
    });
    it('should return a valid authorization header (sha256)', function() {
      var credentials, header;
      credentials = {
        id: '123456',
        key: '2983d45yun89q',
    ...
    it('should return an empty authorization header on missing options', function() {
      var header;
      header = Hawk.header('https://example.net/somewhere/over/the/rainbow', 'POST').field;
      return expect(header).toEqual('');
    });
    it('should return an empty authorization header on invalid credentials', function() {
      var credentials, header;
      credentials = {
        key: '2983d45yun89q',
        algorithm: 'sha256'
    ...
    return it('should return an empty authorization header on invalid algorithm', function() {
      var credentials, header;
      credentials = {
        id: '123456',
        key: '2983d45yun89q',
  ...
  return describe('#authenticate', function() {
    it('should return false on invalid header', function() {
      var res;
      res = {
        headers: {
      ...
      return expect(Hawk.authenticate(res, {})).toBe(false);
    });
    it('should return false on invalid mac', function() {
      var artifacts, res;
      res = {
        headers: {
    ...
    it('should return true on ignoring hash', function() {
      var artifacts, res;
      res = {
        headers: {
          'content-type': 'text/plain',
    ...
    it('should fail on invalid WWW-Authenticate header format', function() {
      var header;
    ...
    return it('should fail on invalid WWW-Authenticate header format', function() {
